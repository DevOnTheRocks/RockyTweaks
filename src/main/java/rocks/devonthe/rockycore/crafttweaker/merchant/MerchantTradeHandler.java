...
public class MerchantTradeHandler {
	...
	public static void addTrade(String profession, String career, IItemStack buy1, IItemStack buy2, IItemStack sell, int level) {
		...
		CraftTweakerAPI.apply(new MerchantTradeHandler.Add(new MerchantTrade(p1, VillagerHelper.getCareer(p1, career).get(), toStack(buy1), toStack(buy2), toStack(sell), level)));
	}
